...
<div class="main-menu material-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true">
    <div class="user-profile">
        <div class="user-info text-center pt-1 pb-1"><img class="user-img img-fluid rounded-circle" src="@if(!empty(auth()->user()->avatar)){{asset('storage/avatars/'.auth()->user()->avatar)}}@else {{asset('app-assets/images/portrait/small/avatar-s-2.png')}} @endif"/>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                <a href="#">
                    ...
                    <span class="menu-title" data-i18n="Expense management">Costs Management</span>
                </a>
                <ul class="menu-content">
                    <li class="{{ Request::routeIs('expense-categories') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('expense-categories')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="Expense Categories">Cost Categories</span>
                        </a>
                    </li>
