								...
								<div role="tabpanel" class="tab-pane active" id="account-vertical-general"
									...
									<div class="media">
										<a href="javascript: void(0);">
											<img src="@if(!empty(auth()->user()->avatar)){{asset('storage/avatars/'.auth()->user()->avatar)}}@else {{asset('app-assets/images/portrait/small/avatar-s-2.png')}} @endif" class="rounded mr-75" alt="profile image" height="64" width="64">
										</a>
