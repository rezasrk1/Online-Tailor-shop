...
Route::group(['middleware'=>'buyer'], function(){
    ...
    Route::get('/dashboad/add_cat/{id}', [CustomerBack::class, 'Dashboard_catr'])->name('customer_cart');
    Route::post('/cart/insert', [CartController::class, 'cartinsert'])->name('carts_inser');
...
Route::group(['middleware'=>['auth']],function (){
    ...
    Route::post('customer', [CustomerBack::class, 'register'])->name('buyerregister_submit');
